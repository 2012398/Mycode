...
class AllChatDoctor extends StatefulWidget {
  const AllChatDoctor({super.key});

  @override
  State<AllChatDoctor> createState() => _AllChatDoctorState();
}

class _AllChatDoctorState extends State<AllChatDoctor> {
  @override
  void initState() {
    super.initState();
    fetchChatRoomIds();
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => DoctorChat(
                    ...
                    doctor: userDetails[index]['uid'].toString(),
                  ),
                ),
              );
